          ...
          <div>
            ...
            <div className="space-y-6 mb-10">
              {[
                ...
                { icon: Phone, label: "Call Us", value: "+974 0000 0000", href: "tel:+97400000000" },
                { icon: MapPin, label: "Our Location", value: "Doha, Qatar", href: "#" },
              ].map((item, i) => (
            ...
            <ScrollReveal delay={0.4}>
              <a href="https://wa.me/97400000000" target="_blank" rel="noopener noreferrer"
                className="flex items-center justify-center gap-3 w-full p-5 rounded-2xl font-display font-bold text-white transition-all duration-300 hover:-translate-y-1"
                ...
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                    ...
                    <div>
                      ...
                      <input type="tel" placeholder="+974 0000 0000" className={inputClasses} value={formData.phone} onChange={(e) => setFormData({ ...formData, phone: e.target.value })} />
                    </div>
                    <div>
